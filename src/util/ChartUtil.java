...
public class ChartUtil {
    ...
    public static void main(String[] args) {
        JPanel p = new JPanel();
        JLabel l = new JLabel();
        Image img = ChartUtil.getImageDefault(400, 300);
    ...
    private static String[] sampleLabelsDefault() {
    ...
    private static double[] sampleValuesDefault() {
    ...
    public static Image getImageDefault(int width, int height){
        // 模拟样本数据
        double[] sampleValues = sampleValuesDefault();
        // 下方显示的文字
        String[] sampleLabels = sampleLabelsDefault();
        // 样本中的最大值
        int max = max(sampleValues);
